...
export const buildContactContextQuery = (query, contactId) => {
...
export const saveContactContext = (query, answer, contactId) => {
...
export const discardExceedConversation = (contactId) => {
  const curContactContext = contactContext.get(contactId);
  if (curContactContext) {
...
export const clearContactContext = (contactId) => {
